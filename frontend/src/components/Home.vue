<template>
  <div class="homeContainer">
    <div class="introduction">
      <img :src="require('../assets/TeachingCode.png')" class="logo">
    ...
    <div class="input-wrapper" :class="{ focused: isInputFocused }">
      <textarea ref="inputField" v-model="userInput" placeholder="给多智能体编程教学系统发送消息" @focus="isInputFocused = true"
        @blur="isInputFocused = false" @keydown.enter.exact.prevent="handleSubmit"></textarea>
      <button class="submit-btn" :disabled="!userInput.trim()" @click="handleSubmit">
